...
<footer class="p-4" style="background-color:#FDB0C0;">
    <div class="d-flex justify-content-around align-items-center redes-sociales">
        <a href="https://www.facebook.com/profile.php?id=61558732494831&mibextid=ZbWKwL"><i class="fa-brands fa-square-facebook"></i></a>
        <p class="text-light">Todos los derechos reservados - 2024 - Kiki&LalaShop </p>
        <a href=" https://www.instagram.com/kikiylala.shop/profilecard/?igsh=cm0zdXVxc2Y4b2J1"><i class="fa-brands fa-square-instagram"></i></a>
